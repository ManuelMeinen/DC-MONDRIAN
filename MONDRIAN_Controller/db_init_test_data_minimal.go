...
func main() {
	...
	// Init Sites
	sites = append(sites, &types.Site{"30.0.0.1", "Site 1"})
	sites = append(sites, &types.Site{"30.0.0.2", "Site 2"})
	
	// Init Subnets
	subnets = append(subnets, &types.Subnet{net.IPNet{IP: net.ParseIP("10.0.1.0"), Mask: net.IPv4Mask(255, 255, 255, 0)}, 1, "30.0.0.1"})
	subnets = append(subnets, &types.Subnet{net.IPNet{IP: net.ParseIP("10.1.0.0"), Mask: net.IPv4Mask(255, 255, 0, 0)}, 1, "30.0.0.1"})
	subnets = append(subnets, &types.Subnet{net.IPNet{IP: net.ParseIP("10.2.0.0"), Mask: net.IPv4Mask(255, 255, 0, 0)}, 2, "30.0.0.1"})
	subnets = append(subnets, &types.Subnet{net.IPNet{IP: net.ParseIP("20.0.1.0"), Mask: net.IPv4Mask(255, 255, 255, 0)}, 1, "30.0.0.2"})
	subnets = append(subnets, &types.Subnet{net.IPNet{IP: net.ParseIP("20.2.0.0"), Mask: net.IPv4Mask(255, 255, 0, 0)}, 3, "30.0.0.2"})
	// Init Transitions
